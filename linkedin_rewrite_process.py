...
async def linkedin_rewrite_process_text(linkedin_text):
    ...
    try:
        ...
        (
            ...
            analyze_personal_info(linkedin_text),
            analyze_experience_info(linkedin_text),
            analyze_education_info(linkedin_text),
            analyze_skill_info(linkedin_text),
            analyze_language_info(linkedin_text)
        )
